  ...
  <div class="budgetAuditing">
    <form class="projectForm">
      ...
      <div class="block">
        <div class="form-item">
          <label>成果文件编号</label>
          <input type="text" placeholder="请输入成果文件编号" v-model="templateform.input33" v-validate="'required'" name="input33" data-vv-as="成果文件编号"  />
        </div>
        <div class="form-item">
          <label>报告编号</label>
      ...
      <div class="block">
        ...
        <div class="form-item">
          <mt-cell title="送报时间">
            <input type="text" @click="openPicker('report')" placeholder="请选择" readonly="readonly" v-model="templateform.input16" v-validate="'required'" name="input16" data-vv-as="送报时间" />
            <i class="iconfont">&#xe630;</i>
          </mt-cell>
        </div>
        ...
        <p>四、审核依据</p>
        <div class="form-item">
          <label>图纸<i class="iconfont iconhelp" @click.stop="help('2018年XX月XX日XX项目施工图纸；2018年XX月XX日图纸疑问回复')"></i> </label>
           <input type="text" placeholder="请输入图纸" v-model="templateform.input18"  v-validate="'required'" name="input18" data-vv-as="图纸"/>
        </div>
        <p>五、审核情况说明</p>
        <p>1.1、工程费用</p>
        <div class="form-item zanding">
          <label for="">送审</label>
          <div class="zandiv">
            <input type="text" placeholder="请输入送审" v-model="templateform.input19" v-validate="'required'" name="input19" data-vv-as="送审" />
            <span>万元</span>
          </div>
        </div>
        <div class="form-item zanding">
          <label for="">审定</label>
          <div class="zandiv">
            <input type="text" placeholder="请输入审定" v-model="templateform.input20" v-validate="'required'" name="input20" data-vv-as="审定" />
            <span>万元</span>
          </div>
        </div>
        <div class="form-item zanding">
          <label for="">审减</label>
          <div class="zandiv">
            <input type="text" placeholder="请输入审减" v-model="templateform.input21" v-validate="'required'" name="input21" data-vv-as="审减" />
            <span>万元</span>
          </div>
        </div>
        <div class="form-item">
          <label>工程费用金额来源</label>
          <textarea name="" id="area" placeholder="请输入工程费用金额来源" v-model="templateform.input22" v-validate="'required'" name="input22" data-vv-as="工程费用金额来源"></textarea>
        </div>
        <p>1.2、其他费用</p>
        <div class="form-item zanding">
          <label for="">送审</label>
          <div class="zandiv">
            <input type="text" placeholder="请输入送审" v-model="templateform.input23"  v-validate="'required'" name="input23" data-vv-as="送审"/>
            <span>万元</span>
          </div>
        </div>
        <div class="form-item zanding">
          <label for="">审定</label>
          <div class="zandiv">
            <input type="text" placeholder="请输入审定" v-model="templateform.input24" v-validate="'required'" name="input24" data-vv-as="审定" />
            <span>万元</span>
          </div>
        </div>
        <div class="form-item zanding">
          <label for="">审减</label>
          <div class="zandiv">
            <input type="text" placeholder="请输入审减" v-model="templateform.input25"  v-validate="'required'" name="input25" data-vv-as="审减"/>
            <span>万元</span>
          </div>
        </div>
        <div class="form-item">
          <label>工程费用金额来源</label>
          <textarea name="" id="area" placeholder="请输入工程费用金额来源" v-model="templateform.input26" v-validate="'required'" name="input26" data-vv-as="工程费用金额来源"></textarea>
        </div>
        <p>1.3、工程预备费</p>
        <div class="form-item zanding">
          <label for="">送审</label>
          <div class="zandiv">
            <input type="text" placeholder="请输入送审" v-model="templateform.input27"  v-validate="'required'" name="input27" data-vv-as="送审"/>
            <span>万元</span>
          </div>
        </div>
        <div class="form-item zanding">
          <label for="">审定</label>
          <div class="zandiv">
            <input type="text" placeholder="请输入审定" v-model="templateform.input28" v-validate="'required'" name="input28" data-vv-as="审定" />
            <span>万元</span>
          </div>
        </div>
        <div class="form-item zanding">
          <label for="">审减</label>
          <div class="zandiv">
            <input type="text" placeholder="请输入审减" v-model="templateform.input29" v-validate="'required'" name="input29" data-vv-as="审减" />
            <span>万元</span>
          </div>
        </div>
        <div class="form-item">
          <label>工程费用金额来源</label>
          <textarea name="" id="area" placeholder="请输入工程费用金额来源" v-model="templateform.input30" v-validate="'required'" name="input30" data-vv-as="工程费用金额来源"></textarea>
        </div>
        <div class="form-item">
          <label>2、重要事项说明</label>
          <textarea name="" id="area" placeholder="请输入重要事项说明" v-model="templateform.input31" v-validate="'required'" name="input31" data-vv-as="重要事项说明"></textarea>
        </div>
        <div class="form-item">
          <label>3、存在的问题及建议</label>
          <textarea name="" id="area" placeholder="请输入存在的问题及建议" v-model="templateform.input32" v-validate="'required'" name="input32" data-vv-as="存在的问题及建议"></textarea>
        </div>
      </div>
    </form>
  </div>
