<template>
  <!-- 进度款审核意见 -->
  <div class="commentsProgressPayment">
    <form class="projectForm">
      ...
      <div class="block">
        ...
        <div class="form-item">
          <mt-cell title="报告日期">
            <input type="text" @click="openPicker('picker')" placeholder="请选择" readonly="readonly" v-model="templateform.input6" v-validate="'required'" name="input6" data-vv-as="报告日期" />
            <i class="iconfont">&#xe630;</i>
          </mt-cell>
        </div>
        ...
        <div class="form-item">
          <label>双方合同名称</label>
          <input type="text" placeholder="请输入双方合同名称" v-model="templateform.input8"  v-validate="'required'" name="input8" data-vv-as="双方合同名称"/>
        </div>
        <div class="form-item">
          <label>监理出具内容</label>
          <input type="text" placeholder="请输入监理出具内容" v-model="templateform.input9"  v-validate="'required'" name="input9" data-vv-as="监理出具内容"/>
        </div>
        <p>审核意见</p>
        ...
        <div class="form-item">
          <label>累计已支付金额</label>
          <input type="text" placeholder="请输入累计已支付金额" v-model="templateform.input13"  v-validate="'required'" name="input13" data-vv-as="累计已支付金额"/>
        </div>
      </div>
      <div class="block">
        <p>附件&其他</p>
