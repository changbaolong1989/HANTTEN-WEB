  ...
  <div class="budgetAudit">
    <form class="projectForm">
      ...
      <div class="block">
        <div class="form-item">
          <label>成果文件编号</label>
          <input type="text" placeholder="请输入成果文件编号" v-model="templateform.input34" v-validate="'required'" name="input34" data-vv-as="成果文件编号" />
        </div>
        <div class="form-item">
          <label>报告编号</label>
      ...
      <div class="block">
        ...
        <div class="form-item">
          <label>
            委托人称呼
            <i class="iconfont iconhelp" @click.stop="help('贵公司、贵单位')"></i>
          </label>
      ...
      <div class="block">
        ...
        <div class="form-item">
          <label>二、审核范围</label>
          <textarea name="" id="area" placeholder="请输入审核范围" v-model="templateform.input15" v-validate="'required'" name="input15" data-vv-as="审核范围"></textarea>
        </div>
        <div class="form-item">
          <label>
            三、审核方法
            <i class="iconfont iconhelp" @click.stop="help('采用全面审核法对本工程进行概算审核')"></i>
          </label>
          <textarea name="" id="area" placeholder="请输入审核方法" v-model="templateform.input16" v-validate="'required'" name="input16" data-vv-as="审核方法"></textarea>
        </div>
        <p>四、审核依据</p>
        <div class="form-item">
          <label>
            图纸
            <i class="iconfont iconhelp" @click.stop="help('XXXX施工图')"></i>
          </label>
          <input type="text" placeholder="请输入图纸" v-model="templateform.input17" v-validate="'required'" name="input17" data-vv-as="图纸" />
        </div>
        <div class="form-item">
          <mt-cell title="法规颁布年份">
            <input type="text" @click="openPicker('particular')" placeholder="请选择" readonly="readonly" v-model="templateform.input18" v-validate="'required'" name="input18" data-vv-as="法规颁布年份" />
            <i class="iconfont">&#xe630;</i>
          </mt-cell>
        </div>
        <mt-datetime-picker ref="particular" v-model="pickerVisible" type="date" @confirm="handleConfirm('input18', 'year')" class="year" :start-date='startDate' :end-date="endDate"></mt-datetime-picker>
        <div class="form-item">
          <label>
            方案资料
            <i class="iconfont iconhelp" @click.stop="help('建设单位提供的工程实施方案及工程概算')"></i>
          </label>
        ...
        <div class="form-item zanding">
          <label for="">送审</label>
          <div class="zandiv">
            <input type="text" placeholder="请输入送审" v-model="templateform.input20" v-validate="'required'" name="input20" data-vv-as="送审" />
            <span>万元</span>
          </div>
        </div>
        <div class="form-item zanding">
          <label for="">审定</label>
          <div class="zandiv">
            <input type="text" placeholder="请输入审定" v-model="templateform.input21" v-validate="'required'" name="input21" data-vv-as="审定" />
            <span>万元</span>
          </div>
        </div>
        <div class="form-item zanding">
          <label for="">审减</label>
          <div class="zandiv">
            <input type="text" placeholder="请输入审减" v-model="templateform.input22" v-validate="'required'" name="input22" data-vv-as="审减" />
            <span>万元</span>
          </div>
        </div>
        <div class="form-item">
          ...
          <textarea
            name=""
            id="area"
            placeholder="请输入工程费用金额来源"
            v-model="templateform.input23"
            v-validate="'required'"
            name="input23"
            data-vv-as="工程费用金额来源"
          ></textarea>
        ...
        <div class="form-item zanding">
          <label for="">送审</label>
          <div class="zandiv">
            <input type="text" placeholder="请输入送审" v-model="templateform.input24" v-validate="'required'" name="input24" data-vv-as="送审" />
            <span>万元</span>
          </div>
        </div>
        <div class="form-item zanding">
          <label for="">审定</label>
          <div class="zandiv">
            <input type="text" placeholder="请输入审定" v-model="templateform.input25" v-validate="'required'" name="input25" data-vv-as="审定" />
            <span>万元</span>
          </div>
        </div>
        <div class="form-item zanding">
          <label for="">审减</label>
          <div class="zandiv">
            <input type="text" placeholder="请输入审减" v-model="templateform.input26" v-validate="'required'" name="input26" data-vv-as="审减" />
            <span>万元</span>
          </div>
        </div>
        <div class="form-item">
        ...
        <div class="form-item zanding">
          <label for="">送审</label>
          <div class="zandiv">
            <input type="text" placeholder="请输入送审" v-model="templateform.input28" v-validate="'required'" name="input28" data-vv-as="送审" />
            <span>万元</span>
          </div>
        </div>
        <div class="form-item zanding">
          <label for="">审定</label>
          <div class="zandiv">
            <input type="text" placeholder="请输入审定" v-model="templateform.input29" v-validate="'required'" name="input29" data-vv-as="审定" />
            <span>万元</span>
          </div>
        </div>
        <div class="form-item zanding">
          <label for="">审减</label>
          <div class="zandiv">
            <input type="text" placeholder="请输入审减" v-model="templateform.input30" v-validate="'required'" name="input30" data-vv-as="审减" />
            <span>万元</span>
          </div>
        </div>
        <div class="form-item">
        ...
        <div class="form-item">
          ...
          <textarea name="" id="area" placeholder="请输入重要事项说明" v-model="templateform.input32" v-validate="'required'" name="input32" data-vv-as="重要事项说明"></textarea>
        </div>
        <div class="form-item">
