export default {
  ...
  formCostConsulting: { // 造价合同
    ...
    fund: "",// 资金来源
    period: "",// 建设工期或周期
    scope: "",// 双方约定的服务范围及工作内容

    deadline: "",// 服务期限
    viabilityStart:new Date(),// 服务期限开始时间
    viabilityEnd:new Date(),// 服务期限结束时间

    copies: "",// 总合同份数
    entrust: "",// 委托人合同份数
    consult: "",// 咨询人合同份数
    representative: "",// 委托人代表
    personnel: "",// 团队人员
    pay: "",// 支付方式
  ...
  formProjectManagementConsultingService: { // 工程管理咨询服务合同
    ...
    useNature: '', // 项目使用性质
    designPay: '', // 设计阶段服务报酬
    isDesignPayProvisional: false, // 设计阶段服务报酬暂定
    constructionPay: '', // 施工阶段服务报酬
    isConstructionPayProvisional: false, // 施工阶段服务报酬暂定
    settlementPay: '', // 结算阶段服务报酬
    isSettlementPayProvisional: false, // 结算阶段服务报酬暂定
    advancePayment: '', // 预付款
    isAdvancePaymentProvisional: false, // 预付款暂定
    progressPayment: '', // 进度款
    isProgressPaymentProvisional: false, // 进度款暂定
    balance: '', // 余款
    isBalanceProvisional: false, // 余款暂定
    addClauses: '', // 附加条款
  },
  formSupervision: { // 监理合同
    ...
    isInstalCostProvisional: false, //工程概算投资额或建筑安装工程费暂定
    engineerName: '', //姓名：3（汉字）
    IDNumber: '', //身份证号：18（数字）
    registrationNumber: '', //注册号
    signAmount: '', //请输入签约酬金与补偿费用
    isSignAmountProvisional: false, //请输入签约酬金与补偿费用 暂定
    superviseDate: '', //监理期限
    superviseDateStart:new Date(),// 监理期限(开始日期)
    startYear: '',
    startMonth: '',
    startDay: '',
    superviseDateEnd:new Date(),// 监理期限(结束日期)
    endYear: '',
    endMonth: '',
    endDay: '',
