 ...
 */
public class HTDictQuestionBean extends BaseBean {
     ...
     * 错误关联列表
     */
    private List<HTDictQuestionBean> htDictQuestionList;
     ...
     */
    public List<HTDictQuestionBean> getHtDictQuestionList() {
     ...
     */
    public void setHtDictQuestionList(List<HTDictQuestionBean> htDictQuestionList) {
