 ...
 */
@Service
public class ListenerContractSeal extends ListenerContractSuper implements TaskListener, ExecutionListener {

    private static final long serialVersionUID = 3858841345447537225L;
    ...
    public void notify(DelegateTask delegateTask) {
        ...
        String userDeptId = WriteContractEnum.Seal.getDepartmentId();//行政部部门ID
        ...
        contractVO.setSubmitNode(WriteContractEnum.Archive.getNodeKey());
        contractVO.setCurrentState(StringToolUtils.convertNullObjectToString(WriteContractEnum.Seal.getNodeSort()));
