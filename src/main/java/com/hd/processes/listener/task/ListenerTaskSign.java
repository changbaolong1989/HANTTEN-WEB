 ...
 */
@Service
public class ListenerTaskSign extends ListenerTaskSuper implements TaskListener, ExecutionListener {

    private static final long serialVersionUID = -8953183168188766001L;
