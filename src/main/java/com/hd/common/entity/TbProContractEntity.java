...
public class TbProContractEntity {
    /**
     * 合同ID
     */
    ...
    /**
     * 动态成本备注
     * @param dynamicRemark 动态成本备注
     */
    public void setDynamicRemark(String dynamicRemark) {
        this.dynamicRemark = dynamicRemark == null ? null : dynamicRemark.trim();
    }
