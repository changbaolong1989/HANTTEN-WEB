...
public class OldProjectInfoReplenish1199 {
    /**
     * 项目主键ID
     */
    private Integer id;
    ...
    /**
     * 导入目标：1 归档, 2 提审
     * @return target_flag 导入目标：1 归档, 2 提审
     */
    ...
    /**
     * 导入目标：1 归档, 2 提审
     * @param targetFlag 导入目标：1 归档, 2 提审
     */
    public void setTargetFlag(String targetFlag) {
        this.targetFlag = targetFlag == null ? null : targetFlag.trim();
    }

    /**
     * 是否作废
     * @return is_cancel 是否作废
     */
