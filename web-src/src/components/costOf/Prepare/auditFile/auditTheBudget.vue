<template>
  ...
  <el-form class="form" ref="form" :model="form" :rules="rule" :disabled="disabled">
    ...
    <div class="form-block">
      <el-row :gutter="gutter">
        <el-col :span="12">
          <el-form-item label="成果文件编号" prop="input34"><el-input v-model="form.input34" placeholder="请输入成果文件编号"></el-input></el-form-item>
        </el-col>
        <el-col :span="12">
    ...
    <div class="form-block">
      ...
      <el-row :gutter="gutter">
        <el-col :span="24">
          <el-form-item label="二、审核范围" prop="input15">
            <el-input v-model="form.input15" type="textarea" placeholder="请输入审核范围"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row :gutter="gutter">
        <el-col :span="24">
          <el-form-item label="三、审核方法" prop="input16">
            <template slot="label">
              三、审核方法
              <i class="el-icon-info" title="采用全面审核法对本工程进行概算审核"></i>
            </template>
            <el-input v-model="form.input16" type="textarea" placeholder="请输入审核方法"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row :gutter="gutter">
      ...
      <el-row :gutter="gutter">
        <el-col :span="12">
          <el-form-item label="图纸" prop="input17">
            <template slot="label">
              图纸
              <i class="el-icon-info" title="XXXX施工图"></i>
            </template>
            <el-input v-model="form.input17" placeholder="请输入图纸"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="规章颁布日期 " prop="input18">
            <el-date-picker v-model="form.input18" type="year" placeholder="请选择年">
            </el-date-picker>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row :gutter="gutter">
        <el-col :span="12">
          <el-form-item label="方案资料" prop="input19">
            <template slot="label">
              方案资料
              <i class="el-icon-info" title="建设单位提供的工程实施方案及工程概算"></i>
            </template>
            <el-input v-model="form.input19" placeholder="请输入方案资料"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row :gutter="gutter">
      ...
      <el-row :gutter="gutter">
        <el-col :span="12">
          <el-form-item label="送审" prop="input20">
            <el-input v-model="form.input20" placeholder="请输入送审">
              <template slot="append">万元</template>
            </el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="审定" prop="input21">
            <el-input v-model="form.input21" placeholder="请输入审定">
              <template slot="append">万元</template>
            </el-input>
          </el-form-item>
        </el-col>
      ...
      <el-row :gutter="gutter">
        <el-col :span="12">
          <el-form-item label="审减" prop="input22">
            <el-input v-model="form.input22" placeholder="请输入审减">
              <template slot="append">万元</template>
            </el-input>
          </el-form-item>
        </el-col>
      ...
      <el-row :gutter="gutter">
        <el-col :span="24">
          <el-form-item label="工程费用金额来源" prop="input23">
            <el-input v-model="form.input23" type="textarea" placeholder="其中内容为解释上面3个金额来源等">
            </el-input>
          </el-form-item>
        </el-col>
      </el-row>
      ...
      <el-row :gutter="gutter">
        <el-col :span="12">
          <el-form-item label="送审" prop="input24">
            <el-input v-model="form.input24" placeholder="请输入送审">
              <template slot="append">万元</template>
            </el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="审定" prop="input25">
            <el-input v-model="form.input25" placeholder="请输入审定">
              <template slot="append">万元</template>
            </el-input>
          </el-form-item>
        </el-col>
      ...
      <el-row :gutter="gutter">
        <el-col :span="12">
          <el-form-item label="审减" prop="input26">
            <el-input v-model="form.input26" placeholder="请输入审减">
              <template slot="append">万元</template>
            </el-input>
          </el-form-item>
        </el-col>
      ...
      <el-row :gutter="gutter">
        <el-col :span="24">
          <el-form-item label="其他费用金额来源" prop="input27">
            <el-input v-model="form.input27" type="textarea" placeholder="其中内容为解释上面3个金额来源等">
            </el-input>
          </el-form-item>
        </el-col>
      </el-row>
      ...
      <el-row :gutter="gutter">
        <el-col :span="12">
          <el-form-item label="送审" prop="input28">
            <el-input v-model="form.input28" placeholder="请输入送审">
              <template slot="append">万元</template>
            </el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="审定" prop="input29">
            <el-input v-model="form.input29" placeholder="请输入审定">
              <template slot="append">万元</template>
            </el-input>
          </el-form-item>
        </el-col>
      ...
      <el-row :gutter="gutter">
        <el-col :span="12">
          <el-form-item label="审减" prop="input30">
            <el-input v-model="form.input30" placeholder="请输入审减">
              <template slot="append">万元</template>
            </el-input>
          </el-form-item>
        </el-col>
      ...
      <el-row :gutter="gutter">
        <el-col :span="24">
          <el-form-item label="其他费用金额来源" prop="input31">
            <el-input v-model="form.input31" type="textarea" placeholder="其中内容为解释上面3个金额来源等">
            </el-input>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row :gutter="gutter">
        <el-col :span="24">
          <el-form-item label="2、重要事项说明" prop="input32">
            <el-input v-model="form.input32" type="textarea" placeholder="重要事项说明"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row :gutter="gutter">
        <el-col :span="24">
          <el-form-item label="3、存在的问题及建议" prop="input33">
            <el-input v-model="form.input33" type="textarea" placeholder="存在的问题及建议"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
    </div>
