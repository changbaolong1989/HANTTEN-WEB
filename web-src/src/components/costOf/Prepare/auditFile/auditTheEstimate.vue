<template>
  ...
  <el-form class="form" ref="form" :model="form" :rules="rule" :disabled="disabled">
    ...
    <div class="form-block">
      ...
      <el-row :gutter="gutter">
        <el-col :span="12">
          <el-form-item label="资料" prop="input18">
            <template slot="label">
              资料
              <i class="el-icon-info" title="与建设项目相关的工程地质资料、设计文件、图纸或有关设计专业提供的主要工程量和主要设备清单等]此内容替换第4项，第五项委托人名称从上面的委托人获取"></i>
            </template>
            <el-input v-model="form.input18" placeholder="请输入资料"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
      ...
      <el-row :gutter="gutter">
        <el-col :span="12">
          <el-form-item label="送审" prop="input21">
            <el-input v-model="form.input21" placeholder="请输入送审">
              <template slot="append">万元</template>
            </el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="审定" prop="input22">
            <el-input v-model="form.input22" placeholder="请输入审定">
              <template slot="append">万元</template>
            </el-input>
          </el-form-item>
        </el-col>
      ...
      <el-row :gutter="gutter">
        <el-col :span="12">
          <el-form-item label="审减" prop="input23">
            <el-input v-model="form.input23" placeholder="请输入审减">
              <template slot="append">万元</template>
            </el-input>
          </el-form-item>
        </el-col>
      ...
      <el-row :gutter="gutter">
        <el-col :span="24">
          <el-form-item label="工程费用金额来源" prop="input24">
            <el-input v-model="form.input24" type="textarea" placeholder="其中内容为解释上面3个金额来源等">
            </el-input>
          </el-form-item>
        </el-col>
      </el-row>
      ...
      <el-row :gutter="gutter">
        <el-col :span="12">
          <el-form-item label="送审" prop="input25">
            <el-input v-model="form.input25" placeholder="请输入送审">
              <template slot="append">万元</template>
            </el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="审定" prop="input26">
            <el-input v-model="form.input26" placeholder="请输入审定">
              <template slot="append">万元</template>
            </el-input>
          </el-form-item>
        </el-col>
      ...
      <el-row :gutter="gutter">
        <el-col :span="12">
          <el-form-item label="审减" prop="input27">
            <el-input v-model="form.input27" placeholder="请输入审减">
              <template slot="append">万元</template>
            </el-input>
          </el-form-item>
        </el-col>
      ...
      <el-row :gutter="gutter">
        <el-col :span="24">
          <el-form-item label="其他费用金额来源" prop="input28">
            <el-input v-model="form.input28" type="textarea" placeholder="其中内容为解释上面3个金额来源等">
            </el-input>
          </el-form-item>
        </el-col>
      </el-row>
      ...
      <el-row :gutter="gutter">
        <el-col :span="12">
          <el-form-item label="送审" prop="input29">
            <el-input v-model="form.input29" placeholder="请输入送审">
              <template slot="append">万元</template>
            </el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="审定" prop="input30">
            <el-input v-model="form.input30" placeholder="请输入审定">
              <template slot="append">万元</template>
            </el-input>
          </el-form-item>
        </el-col>
      ...
      <el-row :gutter="gutter">
        <el-col :span="12">
          <el-form-item label="审减" prop="input31">
            <el-input v-model="form.input31" placeholder="请输入审减">
              <template slot="append">万元</template>
            </el-input>
          </el-form-item>
        </el-col>
      ...
      <el-row :gutter="gutter">
        <el-col :span="24">
          <el-form-item label="其他费用金额来源" prop="input32">
            <el-input v-model="form.input32" type="textarea" placeholder="其中内容为解释上面3个金额来源等">
            </el-input>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row :gutter="gutter">
        <el-col :span="24">
          <el-form-item label="2、重要事项说明" prop="input33">
            <el-input v-model="form.input33" type="textarea" placeholder="重要事项说明"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row :gutter="gutter">
        <el-col :span="24">
          <el-form-item label="3、存在的问题及建议" prop="input34">
            <el-input v-model="form.input34" type="textarea" placeholder="存在的问题及建议"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
    </div>
    ...
    methods: {
      getDetailInfo() {
        if (!this.tool.isNull(this.currentTransmittedData.formworkContent) && this.template == this.currentTransmittedData.formworkType) {
          ...
          this.form.input16 = this.tool.formatToDate(this.form.input16);
        }
      }
    }
  }
