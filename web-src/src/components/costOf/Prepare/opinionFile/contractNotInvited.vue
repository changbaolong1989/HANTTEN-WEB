<template>
  ...
  <el-form class="form" ref="form" :model="form" :rules="rule" :disabled="disabled">
    ...
    <div class="form-block">
      ...
      <el-row :gutter="gutter">
        <el-col :span="24">
          <el-form-item label="资质条件" prop="input7">
            <el-input v-model="form.input7" type="textarea" placeholder="请输入资质条件"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row :gutter="gutter">
        <el-col :span="12">
          <el-form-item label="合同金额" prop="input8">
            <template slot="label">
              合同金额
              <i class="el-icon-info" title="金额单位为元，金额千分符，小数点后两位"></i>
            </template>
            <el-input v-model="form.input8" placeholder="请输入合同金额">
