<template>
  ...
  <div class="m-work-contract-foundItem">
    ...
    <div class="btn-group" v-if='transmittedData.hasContractApply === "0" && transmittedData.isMainHeadFlag === "1" && transmittedData.isInvalidFlag !== "1"'>
    ...
    methods: {
      ...
      save(){
        ...
        vm.$confirm('是否提交?', '提示', {
          ...
          vm.bus.$emit('saveProjectBasicInformation');
