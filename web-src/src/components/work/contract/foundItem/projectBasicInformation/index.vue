    ...
    watch:{
      ...
      transmittedData:{
        handler(){
          ...
          vm.disabled = vm.currentTransmittedData.isInvalidFlag === "1" || vm.currentTransmittedData.hasContractApply !== "0";
        },
        immediate: true
      },
      // 表单信息
    ...
    methods: {
      ...
      excSearchBaseContractDetailInfo(){
        ...
        vm.apiAddress("/contract/query/excSearchBaseContractDetailInfo", {
          "projectId":vm.currentTransmittedData.projectId
        }).then(res => {
      ...
      save() {
        ...
        vm.$nextTick(function() {
          ...
          vm.$refs['baseContract'].getData().then(function(data){
            ...
            data.append("projectId",vm.currentTransmittedData.projectId);
            // 保存
